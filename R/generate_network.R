...
#' @export
#'
#' @examples generate_network("Random Network", c(10, "gnm", 10, "TRUE"))
#' generate_network("Random Network", c(10, 0.2))
generate_network = function(net_name, net_params) {
  ...
  # 简单说来，就是少量高度节点(hub)和大量低度节点
    ...
    net_graph = igraph::barabasi.game(net_params[1], power = net_params[2])
  }
  # 参数net_name错误
  else {
